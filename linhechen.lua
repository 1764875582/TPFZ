...
dI=gg.prompt({"❤️输入你的迷你号❤️","开启网抑云✔️"},{[1] = zh,[2] = nil},{[1] = "number",[2] = "checkbox"}) if dI[2] ==true then  YY998() end   zh = dI[1]  io.open("/sdcard/鹤辰配置文件.txt", "w") io.open("/sdcard/鹤辰配置文件.txt", "w"):write("👣" .. zh .. "👣"):close()
b=a 
gg.toast("当前迷你号:"..b.."林鹤辰yyds")
...
function Main()  local sjbq=bqt[math.random(1,#bqt)] SY = gg.choice({
    [1] = sjbq.."🐬⚽️❤️房主才能用(鹤辰)❤🎾️🐬"..sjbq,
    [2] = sjbq.."🐬⛳️❤️联机开挂Pro功能❤🏓️🐬"..sjbq,
    [3] = sjbq.."🐬🎿❤️鹤辰专属炸图功能❤🏓️🐬"..sjbq,
    [4] = sjbq.."🐬🎿❤️搬的特效功能❤🏌️🐬"..sjbq,
    [5] = sjbq.."🐬🎿❤️️鹤辰专属狙击功能❤️🏓🐬"..sjbq,
    [6] = sjbq.."🐬🎿❤️特别感谢大家提供的源码❤🏂️🐬"..sjbq,
      [7] = sjbq.."🐬🍓❤️播放音乐 ❤🥦️🐬"..sjbq,
    [15] = sjbq.."🐬🥑🌺️退 出 鹤 神 界🌺🥑🐬"..sjbq,
},2018,os.date("❤️鹤辰:".."『"..K.."』❤️\n🧊当前时间%Y年%m月%d日%H时%M分%S秒🧊"))
